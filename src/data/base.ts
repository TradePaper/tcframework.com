...
export const SPECTRUM_STATES: SpectrumState[] = [
  ...
  { pos: 60, label: "Tier 2", tier: "2", howey: "Investment contract uncertain — credible separation argument", analysis: "The governance-and-migration package constrains founding entity discretion across the most important dimensions. A Tier 2 structure, combined with fulfillment or public abandonment of all issuer promises, can satisfy the Release's separation doctrine. This is the appropriate structural target for a credible separation argument and for a decentralization determination under a statutory pathway if one is enacted; an exemption request or, as a costly fallback, a no-action letter draw on the same structure.", color: "#185FA5" },
