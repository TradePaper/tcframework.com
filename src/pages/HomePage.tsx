      ...
      <div className="container">
        <div style={{ padding: "80px 0 64px", borderBottom: "1px solid var(--border)" }}>
          ...
          <div className="release-banner" style={{ maxWidth: "600px", marginBottom: "32px" }}>
            <strong>New:</strong> The March 17, 2026 joint SEC/CFTC interpretive release (Release Nos. 33-11412; 34-105020) establishes a five-category asset taxonomy, an issuer-promise-centric <em>Howey</em> framework, and a separation doctrine that maps directly onto the TCF&apos;s design criteria.{" "}
