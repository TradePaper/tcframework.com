    ...
    return (
      <div className="page">
        <div className="container-narrow" style={{ padding: "48px 40px" }}>
          ...
          <p style={{ fontSize: "16px", color: "var(--ink-mid)", lineHeight: 1.65, marginBottom: "24px" }}>The diagnostic also informs the registration decision. Reaching Tier 2 on all 18 issues is the structural basis for a credible separation argument today and for a decentralization determination under the pending CLARITY Act if enacted; a disclosure-based exemption under Regulation Crypto Assets (previewed, not yet codified) or — as a costly last resort — a no-action request are downstream consumers of the same work. Where gaps remain, the diagnostic quantifies the structural investment required, which you can weigh against the compliance burden of registered securities status.</p>
          <div className="release-banner" style={{ marginBottom: "24px" }}>
            This assessment now includes Issue 4.3 (Revenue Routing / Buy-Burn) and Question 18 (Separation Doctrine Compliance), both added in light of the March 17, 2026 SEC/CFTC Release.
          </div>
