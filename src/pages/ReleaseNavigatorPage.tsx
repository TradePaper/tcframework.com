        ...
        {tab === "pathways" && (
          <div>
            <p style={{ fontSize: "15px", color: "var(--ink-mid)", lineHeight: 1.65, marginBottom: "16px", maxWidth: "760px" }}>
              The same structural work — reducing founding entity discretion across all 18 issues — supports every available route to regulatory clarity. The route is a downstream choice; the structure is the product. A no-action letter is the most burdensome of these routes and, for most early-stage projects, the least practical. Statutory and exemptive pathways are where the field is heading.
            </p>
            ...
            <div style={{ display: "grid", gap: "16px" }}>
              {[
                {
                  title: "Pathway 1 — Regulation Crypto Assets Exemptions (Chair Atkins, March 19, 2026)",
                  body: "Three pathways previewed under anticipated rulemaking: a Startup Exemption (up to $5M over 4 years; disclosure obligations; EDGAR notice filings; non-exclusive alongside Reg D), a Fundraising Exemption for larger raises with more substantive financial disclosure, and an Investment Contract Safe Harbor under which issuers satisfy defined structural milestones to achieve clean separation. These are previewed, not codified; final form depends on exemptive rulemaking and potentially on market structure legislation. A project that builds a Tier 2 structure now is positioned to step into any of them without remediation.",
                  fit: "Best positioned for: all projects. TCF structural work is the prerequisite for any exemption pathway.",
                },
                {
                  title: "Pathway 2 — Digital Asset Market Clarity Act (statutory, pending)",
                  body: "The Digital Asset Market Clarity (CLARITY) Act would put the Release's separation result on a statutory footing through a network-token / ancillary-asset framework, originator disclosure obligations, secondary-market treatment for network-token transactions outside the original investment-contract distribution chain, and certification mechanics for assets that are no longer ancillary assets. Critically, the markup text's control concepts — coordinated control, common control, decentralized governance systems, rules-based processes, and absence of unilateral originator authority — map directly onto the founding-entity discretion the TCF's 18 issues measure. A project that builds a Tier 2 structure now is positioned to support a certification or decentralization determination if the Act becomes law. The Senate Banking Committee advanced H.R. 3633 on May 14, 2026; this discussion uses the Committee's market-structure substitute text released May 12, 2026 as EHF26374, principally §§ 102-105. The Act remains pending legislation, not enacted law, and the TCF's analysis does not assume its passage. Clarity may also emerge through coordinated commercial practice, but only if advisors converge on a common analytical framework — part of why the TCF advocates adoption as that common structure.",
                  fit: "Best positioned for: projects structuring now to qualify under a statutory decentralization pathway if enacted.",
                },
                {
                  title: "Pathway 3 — No-Action Letters (legacy route)",
                  body: "A no-action letter remains available, but it is the most expensive and least scalable form of clarity: slow, fact-specific, counsel-intensive, and granted one structure at a time. For an early-stage project still searching for product-market fit, the cost and timeline are usually prohibitive. Its main analytical value today is diagnostic — it shows how burdensome the pre-CLARITY regime is, and why a standardized statutory or exemptive pathway is preferable. Where it is pursued, a Tier 2 TCF structure presents the Staff with a legible, verifiable account of how founding entity discretion has been reduced, and a pre-distribution request carries substantially more weight than a retroactive one.",
                  fit: "Best positioned for: a narrow set of well-capitalized, late-stage projects with a specific, novel structure and no available exemption.",
                },
              ].map((pathway) => (
        ...
        {tab === "audit" && (
          <div>
            ...
            <p style={{ fontSize: "14px", color: "var(--ink-mid)", lineHeight: 1.65, marginBottom: "16px", maxWidth: "700px" }}>
              This output also supports the registration decision itself. A fully Tier 2 structure with resolved promises is the structural basis for a separation argument today and for a decentralization determination under a statutory pathway if one is enacted; an exemption filing or, as a costly fallback, a no-action request draw on the same work. Unresolved gaps quantify the structural investment required if a project wants to avoid registered-status compliance.
            </p>
